...
ProcessorCommand::ProcessorCommand(const CommandData &data, Address address, LabelContainer *labelContainer,
                                   ErrorContainer *errorContainer)
        : Command(data, address, labelContainer, errorContainer)
{
    extractCode(data);
}
